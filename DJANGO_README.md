...
The Python/Django backend is located inside the [`django_backend/`](./django_backend) directory. It is engineered with a modular, layered architecture adhering to enterprise software engineering standards, separating parsers, transformation converters, matching engines, exception managers, audit stores, and RESTful view controllers.
